                        ...
                        <details>
                            ...
                            <div>
                                ...
                                <select id="lugar_nacimiento" name="lugarNacimientoID" required>
                                    <option value="">- Seleccione -</option>
                                    <option value="chiapas" <?php echo (isset($formData['lugarNacimientoID']) && $formData['lugarNacimientoID'] === 'chiapas') ? 'selected' : ''; ?>>Chiapas</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <div>
                                    ...
                                    <select name="estadoCivilID" id="estado_civil" required>
                                        <option value="">-Seleccione-</option>
                                        <option value="1" <?php echo (isset($formData['estadoCivilID']) && $formData['estadoCivilID'] === '1') ? 'selected' : ''; ?>>Soltero</option>
                                        <option value="2" <?php echo (isset($formData['estadoCivilID']) && $formData['estadoCivilID'] === '2') ? 'selected' : ''; ?>>Casado</option>
                                ...
                                <div>
                                    ...
                                    <select id="grupo_sanguineo" name="grupoSanguineoID" required>
                                        <option value="">- Seleccione -</option>
                                        <option value="1" <?php echo (isset($formData['grupoSanguineoID']) && $formData['grupoSanguineoID'] === '1') ? 'selected' : ''; ?>>A+</option>
                                        <option value="2" <?php echo (isset($formData['grupoSanguineoID']) && $formData['grupoSanguineoID'] === '2') ? 'selected' : ''; ?>>A−</option>
                                        <option value="3" <?php echo (isset($formData['grupoSanguineoID']) && $formData['grupoSanguineoID'] === '3') ? 'selected' : ''; ?>>B+</option>
                                        <option value="4" <?php echo (isset($formData['grupoSanguineoID']) && $formData['grupoSanguineoID'] === '4') ? 'selected' : ''; ?>>B−</option>
                                        <option value="5" <?php echo (isset($formData['grupoSanguineoID']) && $formData['grupoSanguineoID'] === '5') ? 'selected' : ''; ?>>AB+</option>
                                        <option value="6" <?php echo (isset($formData['grupoSanguineoID']) && $formData['grupoSanguineoID'] === '6') ? 'selected' : ''; ?>>AB−</option>
                                        <option value="7" <?php echo (isset($formData['grupoSanguineoID']) && $formData['grupoSanguineoID'] === '7') ? 'selected' : ''; ?>>O+</option>
                                        <option value="8" <?php echo (isset($formData['grupoSanguineoID']) && $formData['grupoSanguineoID'] === '8') ? 'selected' : ''; ?>>O−</option>
                                        <option value="9" <?php echo (isset($formData['grupoSanguineoID']) && $formData['grupoSanguineoID'] === '9') ? 'selected' : ''; ?>>No lo sé</option>
                                    </select>
                                </div>
